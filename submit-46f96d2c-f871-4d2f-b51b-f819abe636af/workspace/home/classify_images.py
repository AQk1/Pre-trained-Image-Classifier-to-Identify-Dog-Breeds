...
def classify_images(images_dir, results_dic, model, dogfile):
    """
    ...
    for filename, pet_info in results_dic.items():
        ...
        # Check if there is a match between pet label and classifier label
        match = 1 if pet_label in classifier_label else 0
        
        # Update the results dictionary with the match result
